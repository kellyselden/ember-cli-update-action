...
exports.modules = {
  ...
  /***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
    ...
    let npmRunPath = ({
      ...
      let cwdString = cwd instanceof URL ? (0, external_node_url_.fileURLToPath)(cwd) : cwd;
    ...
    let applyPreferLocal = (result, cwdPath) => {
      let previous;
    ...
    let applyExecPath = (result, execPath, cwdPath) => {
      let execPathString = execPath instanceof URL ? (0, external_node_url_.fileURLToPath)(execPath) : execPath;
